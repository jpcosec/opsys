...
- **Supervisor** (`desk/agents/supervisor.md`): Handles planning, routing tasks, launching subagents, monitoring testing, syncing the board, and enforcing closeout rituals.
- **Executor** (`desk/agents/executor.md`): Operates blindly on exactly *one* bounded task at a time, writes the code/tests, persists run traces, and stops exactly at the task boundary.
...
- Create default `desk/agents/supervisor.md` and `desk/agents/executor.md` templates in the deskops scaffold.
