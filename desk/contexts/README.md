...
- Durable residue discovered through pills should graduate into atoms before the pill disappears.
- Reusable context is preserved by git history even after workspace deletion.

See `desk/contexts/pills.md` for the current pill convention.
