---
id: task-design-operational-cli-grammar
status: active
references:
...
current_node: checklist-task-design-operational-cli-grammar-execution-ready
history: []
tags:
- workspace:desk
- artifact:task
...
# Design operational CLI grammar
...
Align deskops CLI commands with spoken workflow nouns and user intent.
...
- `status` or `doctor`
- `atoms list/show/new/validate`
- `graph trace/reflect/missing`
- `materialize`
- `drift check`
- `closeout`
...
Promoted from desk/drawer/tasks/task-design-operational-cli-grammar.md.
