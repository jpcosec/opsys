...
current_node: checklist-task-detect-and-migrate-legacy-desk-workspaces-closeout-ready
history:
...
- fb49f21
- tests/test_cli.py
- atom:atom-desk-workspaces-classify-as-absent-empty-legacy-or-current
depends_on: []
pills:
...
atoms:
- atom-desk-workspaces-classify-as-absent-empty-legacy-or-current
