---
id: checklist-task-task-lifecycle-preserve-evidence-on-closeout-closeout-ready
status: active
condition_refs:
- condition-task-task-lifecycle-preserve-evidence-on-closeout-ready-for-closeout
mode: all
tags:
- primitive:checklist
---
