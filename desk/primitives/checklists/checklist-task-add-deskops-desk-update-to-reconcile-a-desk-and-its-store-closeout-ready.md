---
# checklist-xxx
id: checklist-task-add-deskops-desk-update-to-reconcile-a-desk-and-its-store-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-add-deskops-desk-update-to-reconcile-a-desk-and-its-store-ready-for-closeout
- condition-task-add-deskops-desk-update-to-reconcile-a-desk-and-its-store-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
