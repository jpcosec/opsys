---
# checklist-xxx
id: checklist-task-anti-pattern-monolithic-api-endpoint-in-sldb-viewer-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-anti-pattern-monolithic-api-endpoint-in-sldb-viewer-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
