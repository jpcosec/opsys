---
# checklist-xxx
id: checklist-task-give-pilldoc-the-lifecycle-slots-its-commands-already-write-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-give-pilldoc-the-lifecycle-slots-its-commands-already-write-ready-for-closeout
- condition-task-give-pilldoc-the-lifecycle-slots-its-commands-already-write-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
