---
# checklist-xxx
id: checklist-task-create-atoms-from-pill-graph-and-diagram-sources-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-create-atoms-from-pill-graph-and-diagram-sources-ready-for-closeout
- condition-task-create-atoms-from-pill-graph-and-diagram-sources-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
