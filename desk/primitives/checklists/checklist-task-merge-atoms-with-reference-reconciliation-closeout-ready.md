---
# checklist-xxx
id: checklist-task-merge-atoms-with-reference-reconciliation-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-merge-atoms-with-reference-reconciliation-ready-for-closeout
- condition-task-merge-atoms-with-reference-reconciliation-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
