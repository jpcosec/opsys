---
# checklist-xxx
id: checklist-task-doctor-confunde-superficies-no-modeladas-con-untracked-en-sldb-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-doctor-confunde-superficies-no-modeladas-con-untracked-en-sldb-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
