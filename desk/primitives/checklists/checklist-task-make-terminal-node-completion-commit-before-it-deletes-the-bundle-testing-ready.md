---
# checklist-xxx
id: checklist-task-make-terminal-node-completion-commit-before-it-deletes-the-bundle-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-make-terminal-node-completion-commit-before-it-deletes-the-bundle-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
