---
# checklist-xxx
id: checklist-task-deskops-rebuilt-on-pron-total-refactor-fireproof-test-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-deskops-rebuilt-on-pron-total-refactor-fireproof-test-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
