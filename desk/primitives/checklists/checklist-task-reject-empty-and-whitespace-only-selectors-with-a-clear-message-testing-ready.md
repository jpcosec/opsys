---
# checklist-xxx
id: checklist-task-reject-empty-and-whitespace-only-selectors-with-a-clear-message-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-reject-empty-and-whitespace-only-selectors-with-a-clear-message-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
