---
# checklist-xxx
id: checklist-task-derive-declared-graph-edges-from-model-containment-and-references-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-derive-declared-graph-edges-from-model-containment-and-references-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
