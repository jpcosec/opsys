---
# checklist-xxx
id: checklist-task-add-promote-no-trackean-el-bundle-generado-en-el-store-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-add-promote-no-trackean-el-bundle-generado-en-el-store-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
