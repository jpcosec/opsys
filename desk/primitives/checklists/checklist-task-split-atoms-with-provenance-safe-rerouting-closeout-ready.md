---
# checklist-xxx
id: checklist-task-split-atoms-with-provenance-safe-rerouting-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-split-atoms-with-provenance-safe-rerouting-ready-for-closeout
- condition-task-split-atoms-with-provenance-safe-rerouting-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
